...
export default function AdminDaysTab({ token }: Props) {
  ...
  return (
    <div className="admin-full-width">
      <h2 className="mono admin-subsection-title">Day tracker</h2>
